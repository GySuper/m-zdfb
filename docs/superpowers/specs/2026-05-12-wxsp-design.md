...
| **M8** | Web UI | FastAPI + Jinja2 + HTMX:Dashboard / Accounts / Tasks / TaskDetail / Logs(SSE) / Config + 扫码二维码嵌入 + 手动触发按钮 | 打开 `127.0.0.1:8765`:看到 4 账号卡片;点 Task #N "重试"立刻触发;Logs 实时流动 | 3d |
